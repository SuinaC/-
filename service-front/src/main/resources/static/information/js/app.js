...
/////////////////////////// Wizard Form ////////////////////////
    ...
    var settinghtml = `<div id="settings" class="">
            ...
            <div class="sidbarchat p-3">
                ...
                <br/><br/>
                <hr class="float-left w-100"/>
                <label class="chkbox boxed mb-2">盒式布局
                    <input name="boxed" value="bodex" class="boxedlayout" type="checkbox" >
                    <span class="checkmark"></span>
                </label><br/>
                <label class="chkbox compact">紧边框布局 
...
//搜索
function searchDisease(id){
    var searchDisease = $("#searchDisease").val();
    if(searchDisease == null || searchDisease == ""){
        swal({
            title: "提示",
            text: "搜索内容不能为空",
            type: "error",
      ...
      location.href="/consumerOrder/searchDisease?searchDisease=" + searchDisease + "&id=" + id;
